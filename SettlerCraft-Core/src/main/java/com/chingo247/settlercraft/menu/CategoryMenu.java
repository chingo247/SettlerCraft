...
public class CategoryMenu extends ACategoryMenu {
    ...
    public CategoryMenu(MenuAPI menuAPI, IEconomyProvider economyProvider, String title, AInventory notThePlayersInventory, String defaultCategory, int defaultCategoryIcon, MenuView view, Map<String, List<CategoryTradeItem>> items) {
        super(menuAPI, economyProvider, title, notThePlayersInventory, defaultCategory, defaultCategoryIcon, view);
        this.items = items;
    }
    
    public CategoryMenu(MenuAPI menuAPI, IEconomyProvider economyProvider, String title, AInventory notThePlayersInventory, String defaultCategory, int defaultCategoryIcon, MenuView view) {
        this(menuAPI, economyProvider, title, notThePlayersInventory, defaultCategory, defaultCategoryIcon, view, new HashMap<String, List<CategoryTradeItem>>());
    }
