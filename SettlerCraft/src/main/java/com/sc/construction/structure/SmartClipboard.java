...
public class SmartClipboard extends CuboidClipboard {
    ...
    private final Comparator<StructureBlock> buildMode;

    public SmartClipboard(CuboidClipboard parent, Comparator<StructureBlock> comparator) {
        super(Vector.ZERO);
        Preconditions.checkNotNull(parent);
        Preconditions.checkNotNull(comparator);
        this.parent = parent;
        this.buildMode = comparator;
    }
