...
public class SyncPlaceTask extends BukkitRunnable {
    ...
    SyncPlaceTask(EditSession session, CuboidClipboard whole, Vector location, int blocksPerInterval) {
        this(session, whole, location, blocksPerInterval, null);
    }

    SyncPlaceTask(EditSession session, CuboidClipboard whole, Vector location, int blocksPerInterval, TaskCompleteCallback callback) {
        this.whole = whole;
