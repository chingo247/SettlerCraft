...
public class StructureAPI extends AbstractStructureAPI<Player, World> {
    ...
    public StructureAPI(ExecutorService executor, APlatform platform, IConfigProvider configProvider) {
        super(executor, platform, configProvider);
    ...
    public Structure create(Player player, StructurePlan plan, World world, Vector pos, Direction direction) throws StructureException {
        ...
        evtm.getEventBus().post(new StructureCreateEvent(structure));
        return structure;
    }
