...
package com.chingo247.settlercraft.main.structure.construction.worldedit;
 ...
 * @author Chingo
 */
public class DemolisionClipboard extends StructureClipboard {

    

    public DemolisionClipboard(CuboidClipboard parent, Comparator<StructureBlock> comparator) {
