...
public class SettlerCraftCommandExecutor implements CommandExecutor {
    ...
    private void listRefundables(CommandSender sender, String[] args) throws CommandException {
        ...
        if (structures.isEmpty()) {
            sender.sendMessage(SettlerCraft.MSG_PREFIX + "There are currently no structures that need to be refunded");
        } else {
    ...
    private void refundAll(CommandSender sender) {
        ...
        if (structures.isEmpty()) {
            sender.sendMessage(SettlerCraft.MSG_PREFIX + "No structures that need to be refunded...");
            return;
        }
    ...
    private void reload(CommandSender sender, String[] args) throws CommandException {
        ...
        SettlerCraft.getInstance().reloadConfig();
...
//                sender.sendMessage(SettlerCraft.MSG_PREFIX + "Config reloaded");
