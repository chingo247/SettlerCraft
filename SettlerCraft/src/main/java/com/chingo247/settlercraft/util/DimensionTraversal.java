 ...
 * @author Chingo
 */
public class DimensionTraversal {
    ...
    private int xIncrement = 40, yIncremenet = 40, zIncrement = 40;
    
    
    

    public DimensionTraversal(Vector size, int cubeX, int cubeY, int cubeZ) {
        this.size = size;
        this.cubeX = cubeX;
        this.cubeY = cubeY;
        this.cubeZ = cubeZ;
     ...
     * @param zCubeIndex 
     */
    private DimensionTraversal(Vector size, int cubeX, int cubeY, int cubeZ, Vector current, int xIndex, int yIndex, int zIndex, int xCubeIndex, int yCubeIndex, int zCubeIndex) {
...
//                xCubeIndex++;
    ...
    public DimensionTraversal copy() {
        return new DimensionTraversal(size, cubeX, cubeY, cubeZ, current, xIndex, yIndex, zIndex, xCubeIndex, yCubeIndex, zCubeIndex);
    }
