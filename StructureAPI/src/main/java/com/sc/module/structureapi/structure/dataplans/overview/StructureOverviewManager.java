package com.sc.module.structureapi.structure.dataplans.overview;
 ...
 * @author Chingo
 */
public class StructureOverviewManager implements StructureListener {
...
//                }
    ...
    public void onCreate(Structure structure) {
        createHolograms(StructureAPI.getPlugin(), structure);
    }
