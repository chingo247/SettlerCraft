...
public class ConstructionBuildingCallback extends ConstructionCallback {
    ...
    ConstructionBuildingCallback(Plugin plugin, UUID issuer, final ConstructionSite cosntructionSite) {
        ...
        entry.addStateChangedListener(new IJobEntryListener() {
            ...
            public void jobStateChanged(JobEntry bpje) {
                ...
                if (bpje.getStatus() == JobStatus.PlacingBlocks) {
                    siteService.setState(constructionSite, State.BUILDING);
                    System.out.println("State changed: " + constructionSite.getState());
                    ...
                    siteService.setState(constructionSite, State.COMPLETE);
                    constructionSite.setCompletedAt(new Date());
                    siteService.save(constructionSite);

                    System.out.println("on complete: " + constructionSite.getState());
