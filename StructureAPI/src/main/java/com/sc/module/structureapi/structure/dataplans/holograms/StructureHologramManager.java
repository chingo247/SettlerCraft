 ...
 */
package com.sc.module.structureapi.structure.dataplans.holograms;
...
import com.sc.module.structureapi.structure.StructureListener;
 ...
 * @author Chingo
 */
public class StructureHologramManager implements StructureListener {
    ...
    private final Plugin plugin = StructureAPI.getPlugin();
    ...
    public void onCreate(final Structure structure) {
        ...
        createHolograms(plugin, structure);
    }
