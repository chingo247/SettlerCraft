...
package com.chingo247.structureapi.persistence.hibernate;
...
public class HibernateUtil {
    ...
    static {
        try {
            ...
            sessionFactory = configuration.configure("com/chingo247/structureapi/resources/hibernate.cfg.xml").buildSessionFactory();
        } catch (Throwable ex) {
            // Log the exception. 
