...
import com.chingo247.structureapi.QSchematicData;
...
import com.chingo247.structureapi.main.persistence.service.AbstractService;
...
public class SchematicManager {
    ...
    public SchematicManager(StructureAPI structureAPI, ExecutorService executorService) {
     ...
     */
    public SchematicData getData(long checksum) {
        Session session = HibernateUtil.getSession();
        QSchematicData qsd = QSchematicData.schematicData;
