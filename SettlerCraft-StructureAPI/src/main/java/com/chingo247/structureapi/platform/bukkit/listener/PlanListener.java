package com.chingo247.structureapi.platform.bukkit.listener;
...
public class PlanListener implements Listener {
    ...
    private final PlayerPlaceStructureHandler placeHandler;

    public PlanListener(IEconomyProvider provider) {
        this.placeHandler = new PlayerPlaceStructureHandler(provider);
    }
    ...
    public void onPlayerUsePlan(final PlayerInteractEvent pie) {
        ...
        if (PlayerPlaceStructureHandler.isStructurePlan(stack)) {
