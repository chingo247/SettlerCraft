 ...
 * @author Chingo
 */
public class AsyncDemolishingPlacement extends AbstractAsyncPlacement<DemolitionOptions, DemolishingPlacement> {
    ...
    @Override
    public void place(EditSession editSession, final Vector pos, final DemolitionOptions options) {
