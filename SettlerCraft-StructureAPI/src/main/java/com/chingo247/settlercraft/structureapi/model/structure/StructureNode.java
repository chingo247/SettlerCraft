 ...
 * @author Chingo
 */
public class StructureNode extends AbstractStructure {
    ...
    public List<StructureNode> getSubstructures() {
        ...
        for (Relationship rel : relationships) {
            ...
            if (substructure.getStatus() != StructureStatus.REMOVED) {
