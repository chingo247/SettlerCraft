...
//    
    ...
    public SCCuboidClipboardWrapper(String player, StructureClipboard smartClipboard) {
        this(player, smartClipboard, -1);
    }

    public SCCuboidClipboardWrapper(String player, StructureClipboard smartClipboard, int jobId) {
